...
import pandas as pd
chans_info_df = pd.read_csv("ghiamp_montage.sfp",header=None, sep="\t",names=["label","X","Y","Z"])
...
hiamp.scale = 30
hiamp.startStreaming(chunk_size=64, sleep=0.01, total_time=30, delay=0.0,terminate=True,
